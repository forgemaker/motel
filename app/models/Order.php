...
class Order extends Eloquent
{
    ...
    protected $fillable = array('room_id', 'motel_data', 'room_data', 'enter_time', 'is_weekend', 'motel_id', 'uid', 'user_name', 'user_phone', 'room_title', 'room_type', 'serial_number', 'total_price', 'date_purchased', 'date_finished', 'status_id', 'rank', 'title', 'description', 'add_time', 'edit_time');

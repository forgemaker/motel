...
function program21(depth0,data) {
  ...
  buffer += escapeExpression(stack2)
    + "\">\n                        <span class=\"input-group-addon\">.00</span>\n                    </div>\n                    <span class=\"help-block\"></span>\n                </div>\n                <div class=\"form-group\">\n                    <label class=\"control-label\">特價(平日)</label>\n                    <div class=\"input-group\">\n                        <span class=\"input-group-addon\">$</span>\n                        <input type=\"text\" name=\"price_2\" class=\"form-control\" placeholder=\"特價(平日)\" value=\"";
  ...
  buffer += escapeExpression(stack2)
    + "\">\n                        <span class=\"input-group-addon\">.00</span>\n                    </div>\n                    <span class=\"help-block\"></span>\n                </div>\n                <div class=\"form-group\">\n                    <label class=\"control-label\">特價(假日)</label>\n                    <div class=\"input-group\">\n                        <span class=\"input-group-addon\">$</span>\n                        <input type=\"text\" name=\"price_3\" class=\"form-control\" placeholder=\"特價(假日)\" value=\"";
...
function program10(depth0,data) {
  ...
  return "<span class=\"label label-warning\" style=\"font-size: 14px\">住宿</span>";
  }

function program12(depth0,data) {
  
  
  return "<span class=\"label label-info\" style=\"font-size: 14px\">休息</span>";
  }
